...
def main():
    ...
    # Analyze the combined repository
    repositories = [
        'reconnaissance'
    ]
    ...
    combined_report = {
        ...
        'combined_summary': {
            ...
            'total_files_analyzed': sum(r['summary']['total_files'] for r in all_results.values()),
            'total_vulnerabilities': sum(r['summary']['total_vulnerabilities'] for r in all_results.values()),
            'high_risk_findings': sum(r['summary']['high_severity_vulns'] for r in all_results.values())
        }
    }
