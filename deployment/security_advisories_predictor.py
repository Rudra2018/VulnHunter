...
class VulnHunterSecurityAdvisoriesPredictor:
    """Custom predictor for security_advisories vulnerability detection"""
    ...
    def predict(self, instances: List[Dict[str, Any]]) -> Dict[str, List]:
        ...
        try:
            ...
            results = {
                ...
                "model_name": "security_advisories",
...
def load_predictor(artifacts_uri: str):
    ...
    global _predictor
    _predictor = VulnHunterSecurityAdvisoriesPredictor()
